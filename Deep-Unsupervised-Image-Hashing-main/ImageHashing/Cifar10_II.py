...
log_filename = 'training_loss_{}.log'.format(time.strftime("%Y%m%d-%H%M%S"))
...
def main():
    ...
    for label in range(10):
        ...
        train_dataset.targets = train_L.astype(np.int64)
        test_dataset.data = test_data
        test_dataset.targets = test_L.astype(np.int64)
        database_dataset.data = data_set
        database_dataset.targets = dataset_L.astype(np.int64)
